...
namespace Restapp.Controllers
{
    public class FoodTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] FoodType foodType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] FoodType foodType)
        {
            if (ModelState.IsValid)
            {
